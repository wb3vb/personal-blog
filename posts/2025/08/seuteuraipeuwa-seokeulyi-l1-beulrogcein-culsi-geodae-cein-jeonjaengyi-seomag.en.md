...
description: 'Stripe and Circle building their own L1s is a bet on owning the financial ledger itself. It could bring millions on-chain, but also revive Web2 walled gardens in Web3.'
---
...
- **For investors**, the key variable that determines a project’s success or failure may not be the superiority of the L1/L2 technology itself, but the ‘power of distribution,’ meaning ‘how many users the company behind it can bring on-chain.’
- **From an ecosystem perspective**, the true winner may not be the most decentralized chain. The side that perfectly abstracts away all of blockchain’s complexity, so that users are not even aware they are using a blockchain, will end up dominating the market. I see Coinbase’s Base App as leading the way in this role.
