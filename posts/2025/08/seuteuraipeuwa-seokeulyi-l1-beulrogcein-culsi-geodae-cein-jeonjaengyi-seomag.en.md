...
Through this, they can absorb all the value generated within the ecosystem without any leakage to the outside. Furthermore, they can directly design the way MEV itself is controlled.

They come to stand in the position of an ‘architect’ who creates the economic model itself—whether by blocking malicious MEV at the source to improve the user experience, or by having the protocol capture that value directly and redistribute it as incentives for the entire ecosystem, such as fee reductions.

### **2) Data Sovereignty and Ecosystem Lock-in**

A blockchain is, in itself, an immutable ledger. To own and operate a Layer-1 means to own all of the transaction data recorded on that ledger. This is equivalent to realizing, in the on-chain world, the **‘data monopoly’** that Web2 companies so desperately craved.
...
In addition, Privy, which it recently acquired, provides technology for managing users’ wallets and identities. Combined with Stripe’s Layer-1, users would be able to operate across millions of Stripe merchants with a single identity.
...
## Circle: A Bold Gambit Toward the Standard for the ‘On-Chain Dollar’
...
- **Developers** will now be placed at a crossroads: Will they innovate on a permissionless, free, but chaotic public chain? Or will they join a massive ecosystem that guarantees stability and enormous numbers of users but requires following a particular company’s rules? That, I suspect, is the question.
- **For investors**, the key variable that determines a project’s success or failure can be seen not as the superiority of the L1/L2 technology itself, but as the ‘power of distribution’—that is, ‘how many users the company behind it can bring on-chain.’
- **From an ecosystem perspective**, the true winner may not be the most decentralized chain. The side that perfectly abstracts away all of blockchain’s complexity—so that users are not even aware they are using a blockchain—will ultimately dominate the market. I see Coinbase’s Base App as leading the way in this role.

Ultimately, I see corporate-led blockchains as one enormous bet: that directly controlling the base layer (Layer-1) will bring better economics, product fit, and value capture than building something on someone else’s rails.
